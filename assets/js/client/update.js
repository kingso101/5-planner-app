$(document).ready(function(){
    ...
    $(document).on('submit', '#profileDetailsForm', function(e){
        ...
        if (up_fname == "" || up_lname == "" || up_email == "" || up_contact_number == "" || up_gender == "" || up_country == "" || up_state == "" || up_dob == "" || up_description == "" || up_address == "" || _id == "") {
            ...
            // get form data
            var obj = { "up_fname":up_fname, "up_lname":up_lname, "up_email":up_email, "up_contact_number":up_contact_number, "up_gender":up_gender, "up_country":up_country, "up_country":up_country, "up_state":up_state, "up_dob":up_dob, "up_description":up_description, "up_address":up_address, "_id":_id };

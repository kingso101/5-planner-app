...
<body>
  <div class="main">
    ...
    <form id="signup_form" class="form1">
      <input class="un " type="text" align="center" name="firstname" id="firstname" placeholder="Enter firstname">
      <input class="un " type="text" align="center" name="lastname" id="lastname" placeholder="Enter lastname">
      ...
      <button class="submit" align="center" id="reg" name="reg" type="submit">Sign Up</button>
      <p class="forgot" align="center"><a href="login">Log In</a> </p>
    </form>
    <script>
                ...
                $.ajax({
                    ...
                    error: function(result){
                        setTimeout(function() {
                            ...
                            // on error, tell the user registration has failed & empty the input boxes
                            toastr.error(result.message);
                            signup_form.find('input').val('');
                            $('#reg').text('Sign Up');
                        }, 4000);
